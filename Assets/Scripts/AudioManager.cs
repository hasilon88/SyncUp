...
//SessionLoudestSample: Current loudest sample
...
public class AudioManager : MonoBehaviour
{
    ...
    /// SHOULD BE IN ITS OWN UTILITY CLASS
    /// </summary>
    ...
    private void AddLoudestSample()
    {
        ...
        else this.lastLoudestSamples = this.Displace(this.lastLoudestSamples, this.CurrentLoudestSample);
    }
