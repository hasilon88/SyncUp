...
public class FirstPersonController : MonoBehaviour
{
    ...
    // Make sure these are public or marked [SerializeField] for them to appear in the Inspector
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.Label("Double Jump", new GUIStyle(GUI.skin.label) { alignment = TextAnchor.MiddleLeft, fontStyle = FontStyle.Bold, fontSize = 13 }, GUILayout.ExpandWidth(true));

        fpc.enableDoubleJump = EditorGUILayout.ToggleLeft(new GUIContent("Enable Double Jump", "Determines if the player is allowed to jump twice."), fpc.enableDoubleJump);

        GUI.enabled = fpc.enableJump;
        fpc.doubleJumpPower = EditorGUILayout.Slider(new GUIContent("Double Jump Power", "Determines how high the player will double jump."), fpc.doubleJumpPower, .1f, 20f);
        GUI.enabled = true;
